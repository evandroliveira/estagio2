...
class clientsController extends controller
{
    ...
    public function add()
    {
        ...
        if ($u->hasPermission('clients_edit')) {
            ...
            if (isset($_POST['name']) && !empty(['name'])) {
                ...
                $c->add($u->getCompany(), $name, $email, $phone, $cpf, $stars, $internal_obs, $address_zipcode, $address, $address_number, $address2, $address_neighb, $address_city, $address_state, $address_country);
    ...
    public function edit($id)
    {
        ...
        if ($u->hasPermission('clients_edit')) {
            ...
            if (isset($_POST['name']) && !empty($_POST['name'])) {
                ...
                $c->edit($id, $u->getCompany(), $name, $email, $phone, $cpf, $stars, $internal_obs, $address_zipcode, $address, $address_number, $address2, $address_neighb, $address_city, $address_state, $address_country);
                header("Location: " . BASE_URL . "/clients");
            }
    ...
    public function delete($id)
    {
        ...
        if ($u->hasPermission('clients_delete')) {
            $c = new Clients();
            $return = $c->deleteClient($id, $u->getCompany());
