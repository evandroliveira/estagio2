...
<form method="POST">
	...
	<input type="text" name="cpf" value="<?php echo $client_info['cpf']; ?>" /><br/><br/>
	...
	<input type="submit" value="Salvar" onclick="return confirm('Tem certeza que deseja alterar os dados?')" />
